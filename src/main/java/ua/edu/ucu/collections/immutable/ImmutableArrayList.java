...
public class ImmutableArrayList implements ImmutableList {
    ...
    @Override
    public ImmutableArrayList add(int index, Object a)
    ...
    @Override
    public ImmutableArrayList addAll(int index, Object[] a)
            throws IndexOutOfBoundsException {
        if (index > this.elements.length || index < 0) {
            throw new IndexOutOfBoundsException();
        }
        ...
        for (int i = a.length + index; i < this.elements.length
                + a.length; i++) {
